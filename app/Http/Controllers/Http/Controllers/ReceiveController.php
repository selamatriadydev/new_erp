...
class ReceiveController extends Controller
{
    ...
    public function detailreturn($id)
    {
        ...
        $tampil = ReturnsupplierModel::join('gudang_models','returnsupplier_models.id_barang','gudang_models.id')
    ...
    public function inputreturn(Request $request)
    {
        ...
        $kurangi = GudangModel::where('id',$value)->update(['stok'=> DB::raw("stok - $kurangs")]);
