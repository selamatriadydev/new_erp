...
@media screen and (max-width: 600px) {
  ...
  <body>
        ...
        <div class="container">
            <a class="navbar-brand" href="#">HI-CODE</a>
      ...
      <div class="row" style="margin-top: 100px;">
        <div class="col-md-2 none" style="height: 600px; background-color: rgba(1, 198, 247, 0.096);"></div>
        <div class="col-md-7" style="height: 300px; ">
            ...
            <div class="content mt-3"  style="background: rgba(50, 226, 6, 0.11); ">
                <div class="row ">
        ...
        <div class="col-md-3 pb-3 shadow" style="background: rgba(206, 241, 2, 0.11); ">
             <div class="row mt-3">
                 <div class="col-md-12">
                 ...
                 <div class="col-md-12">
                    <table class="table ">
                        ...
                        <!-- foreach -->
                          ...
                          <tr>
                              <td>{{$carts->nama_barang}}
                                  <br>@currency($carts->harga_up)</td>
                              <td>{{$carts->qty}}</td>
