...
class AkunController extends Controller
{
    ...
    public function index()
    {
        ...
        $user = User::join('cabang','users.cabang_id','=','cabang.id')->where('users.id','!=', Auth::user()->id)->where('users.cabang_id',$cabang)->select('users.id','users.name','users.email','users.hak_akses','cabang.nama_cabang')->get();
        return view('akun.index',compact('user','cabang'));
    }
