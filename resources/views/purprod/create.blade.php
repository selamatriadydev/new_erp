          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> PURCHASING PRODUKSI</h4>
              </div>
              @if ($errors->any())
            ...
            <form action="{{route('storeprod')}}" method="POST">
                ...
                <div class="form-body">
                                ...
                                <input type="hidden" name="nama_gudang" value="Admin Gudangcabang" class="form-control" readonly>
                                        ...
                                        <tr class="rows">
                                            ...
                                            <select name="id_bahanbaku[]" class="form-control">
                                                ...
                                                @foreach($bahanbaku as $bah)
                                                    <option value="{{$bah->id}}">{{$bah->nama_barang}} {{$bah->berat}} {{$bah->nama_satuan}} || {{$bah->stok}}</option>
                                                @endforeach
                                            </select>  
                                            </td>
                                            <td style="border-top: none;">
