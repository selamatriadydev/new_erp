                ...
                <div class="form-body">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                        <div class="card-body">
                                                <label for="">Code Komponen</label>
                                                <input type="text" name="code_komponen" value="{{$kode}}" class="form-control" readonly>
                                            </div>
                                            <div class="card-body">
...
$(newitem).click(function(e) {
  e.preventDefault();
  $newrow = $('<tr class="rows"><td style="border-top: none;"><select name="id_item[]" class="form-control"><option value="" disabled selected>--Pilih Item--</option>@foreach($item as $items)<option value="{{$items->id}}">{{$items->nama_item}}</option>@endforeach</select></td><td style="border-top: none;" class="text-center"><a class="removeitem" href="#"><i class="fa fa-times"></i></a></td></tr>');
