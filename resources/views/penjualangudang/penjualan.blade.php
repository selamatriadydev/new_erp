                                        ...
                                        <tr class="rows">
                                            ...
                                            <select name="id_barang[]" class="form-control">
                                                ...
                                                @foreach($gudang as $gud)
                                                    <option value="{{$gud->id}}">{{$gud->nama_barang}}</option>
                                                @endforeach
                                            </select>
                                            </td>
                                            <td style="border-top: none;">
