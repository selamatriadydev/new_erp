...
<div class="content">
        <div class="row">
          <div class="col-md-12">
            ...
            <form action="{{route('inputreturn')}}" method="POST">
                @csrf
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="card-body">
                                                <label for="">No Return</label>
                                                <input type="text" name="no_return" value="{{$kode}}" class="form-control" readonly>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <input type="date" name="tgl_return" value="{{$ldate}}" class="form-control" readonly>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                ...
                                                <select name="status_return" class="form-control" required>
                                                <option value="" >--Pilih Status Return--</option>
                                                <option value="Badstok">Bad Stok</option>
                                                <option value="Goodstok">Good Stok</option>
                                                </select>    
                                            </div>
                                        ...
                                        <tr class="rows">
                                            ...
                                            <select name="id_barang[]" class="form-control">
                                                ...
                                                @foreach($bahanbaku as $bah)
                                                    <option value="{{$bah->id}}">{{$bah->nama_barang}} {{$bah->nama_satuan}}</option>
                                                @endforeach
                                            </select>
                                            </td>
                                            <!--<td style="border-top: none;">-->
