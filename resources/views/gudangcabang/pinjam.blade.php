          ...
          <div class="col-md-12">
            ...
            <form action="{{route('inputpinjam')}}" method="POST">
                ...
                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <input type="text" name="no_peminjaman" value="{{$kode}}" class="form-control" readonly>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <input type="date" name="tanggal_peminjam" value="{{$ldate}}" class="form-control" readonly>
                                            </div>
                                ...
                                <input type="hidden" name="id_cabang" value="{{$pinjam}}">
