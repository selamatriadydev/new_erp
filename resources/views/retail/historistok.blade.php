          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> HISTORY STOK</h4>
              </div>
              ...
              <div class="card">
                ...
                <div class="dropdown">
                                    ...
                                    <form action="{{route('retail.filterhistoristok')}}" method="get">
                                        <div class="row input-daterange">
                                            ...
                                            <div class="col-md-2">
                                            <a href="{{route('retail.historistok')}}" class="btn btn-green d-none d-lg-block m-l-15"><i class="fas fa-arrow-alt-circle-left"></i>reset</a>
                                            </div>
                                        </div>
                                    </form>
                    <div class="col-md-5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ \Carbon\Carbon::parse($st->tgl_restok)->isoFormat('dddd, D MMMM Y')}}</td>
                    </tr>
                    @endforeach
                </tbody>
