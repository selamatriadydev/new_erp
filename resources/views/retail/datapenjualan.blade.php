          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> PENJUALAN RETAIL</h4>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="dropdown">
                                    ...
                                    <form action="{{route('filterdatapenjualan')}}" method="get">
                                        <div class="row input-daterange">
                                            ...
                                            <div class="col-md-2">
                                            <a href="{{route('retail.datapenjualan')}}" class="btn btn-green d-none d-lg-block m-l-15"><i class="fas fa-arrow-alt-circle-left"></i>Hari ini</a>
                                            </div>
                                        </div>
                                    </form>
                    <div class="col-md-5">
                ...
                <tbody>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td bgcolor="yellow"><b>@currency($profit)</b></td>
                        </tr>
                    </tfoot>
                  </table>
                </div>
...
<script>
    ...
    $('#example').DataTable( {
        dom: 'Bfrtip',
        buttons: [
            'copy', 'csv', 'excel', 'pdf', 'print', 'footer: true'
        ]
    } );
} );
</script>
