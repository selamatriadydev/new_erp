          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> PURCHASING EGG</h4>
              </div>
              @if ($errors->any())
                ...
                <div class="form-body">
                                ...
                                <div class="">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                <label for="">Purchase to Cabang</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                <label for="">Purchase to Unit</label>
                                                <select name="gudang_peminta" class="form-control"> 
                                                  <option value="Admin GudangCabang">Admin Gudangcabang</option>
                                                  <option value="Admin Bigwarehouse">Admin Bigwarehouse</option>
                                                  <option value="Admin Premixwarehouse">Admin Premixwarehouse</option>
                                        </select>                                            
                                        </div>
                                        </div>
                                ...
                                <input type="hidden" name="nama_gudang" value="{{Auth::user()->hak_akses}}">
                                <!-- <input type="hidden" name="gudang_peminta" value="Admin GudangCabang"> -->
                                <input type="hidden" name="to" value="{{Auth::user()->cabang_id}}">
