                ...
                <div class="form-body">
                                ...
                                <div class="">
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="nama_gudang" value="Admin Bigwarehouse" class="form-control" >
                                        <div class="col-md-6">
                                        ...
                                        <select name="pembuat" class="form-control"> 
                                                  @foreach($users as $sr)
                                                  <option value="{{$sr->id}}">{{$sr->nama_cabang}}</option>
                                                 @endforeach
                                        </select> 
                                        </div>
                                        ...
                                        <tr class="rows">
                                            ...
                                            <select name="id_bahanbaku[]" class="form-control">
                                                ...
                                                @foreach($bahanbaku as $bah)
                                                    <option value="{{$bah->id}}">{{$bah->nama_barang}} {{$bah->berat}} {{$bah->nama_satuan}} || {{floor($bah->stok)}}</option>
                                                @endforeach
                                            </select>  
                                            </td>
                                            <td style="border-top: none;">
