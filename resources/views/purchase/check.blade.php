          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">CHECK BARANG</h4>
              </div>
              ...
              <div class="card-body">
                            ...
                            <!-- <select name="tujuan" class="form-control">
                                ...
                                <a href="{{route('purchase.big')}}" class="btn btn-success">create</a>
                            </div>
                ...
                @foreach ($data as $datas)
                    ...
                    <div class="btn-group">
                            <a href="{{route('lihat',$datas->id)}}" class="btn btn-warning">check</a>
                        </div>
                        <!-- <div class="btn-group">
