          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> PAYMENT PIUTANG CABANG</h4>
              </div>
              @if ($errors->any())
            ...
            <form action="{{route('inputbayarhutang')}}" method="POST">
                <div class="form-body">
                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <input type="text" name="no_peminjaman" value="{{$no_peminjaman}}" class="form-control" readonly>
                                            </div>
