            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <tr> 
                    ...
                    <td>
                    <div class="btn-group">
                            <a href="{{route('detailtocabang',$tam->id)}}" class="btn btn-success">Detail</a>
                        </div>
                        <div class="btn-group">
                            <a href="{{route('detailbayarcabang',$tam->id)}}" class="btn btn-success">Detail Hutang</a>
                        </div>
