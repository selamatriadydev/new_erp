        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
              <div class="btn-group">
                                <a href="{{route('tampilpinjam')}}" class="btn btn-success">Back</a>
                            </div>     
                ...
                <tr> 
                    ...
                    <td>
                        ...
                        @if($tam->status == "Open")
                        <div class="btn-group">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal<?php echo $tam->id?>">
                        edit
                        </button>
                        </div>
                        <div class="btn-group">
                            <a href="{{ route('ditolak',(['id'=>$tam->id]))}}" class="btn btn-success">ditolak</a>
                        </div>
                        <div class="btn-group">
                            <a href="{{ route('setujui',(['id'=>$tam->id]))}}" class="btn btn-success">Setujui</a>
                        </div>
                        @endif
                    </td>
                </tr>
